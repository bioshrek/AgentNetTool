...
class AgentNetBackend:
    ...
    def _setup_routes(self):
        routes = [
            ...
            ("/api/recording/<recording_name>/regenerate_clip/<event_index>", self.recording_controller.regenerate_clip_endpoint, {"methods": ["POST"]}),
            ("/api/recording/<recording_name>/regenerate_clip/<event_index>/<int:verifying>", self.recording_controller.regenerate_clip_endpoint, {"methods": ["POST"]}),
            # Browser Integration
